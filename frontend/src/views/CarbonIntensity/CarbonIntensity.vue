...
<template>
  ...
  <div class="carbon-2">
    <h2>Info</h2>
    <ul>
      <li>This data is from the <a href="https://carbonintensity.org.uk/">carbon intensity API</a> by National Grid, WEF, University of Oxford, and Environmental Defence Fund.</li>
