...
const makeTimeString = (timestamp) => `${timestamp.getUTCHours().toString()}${timestamp.getUTCMinutes().toString().padStart(2, '0')}${timestamp.getUTCSeconds().toString().padStart(2, '0')}`;
